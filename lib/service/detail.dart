            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  MovieInfoItem(title: 'Director', info: anime.director),
                  MovieInfoItem(title: 'Producer', info: anime.producer),
                  MovieInfoItem(title: 'Release Date', info: anime.releaseDate),
                  MovieInfoItem(title: 'Running Time', info: anime.runningTime),
                  MovieInfoItem(
...
class MovieInfoItem extends StatelessWidget {
  ...
  const MovieInfoItem({super.key, required this.title, required this.info});
